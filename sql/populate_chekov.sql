...
INSERT INTO videos (id, name, is_remote, is_available, url, dialogue, tlp_id) values (NULL, 'Captains-Quarters', false, false, 'https://xscratch-videos.s3.us-east-2.amazonaws.com/C8-Captains_Quarters.ogg', 'There is a duty to be performed in the Captains quarters', NULL);  -- 8
